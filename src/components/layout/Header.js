      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center">
            <motion.span 
              className="text-2xl font-bold text-black dark:text-white tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-stone-700 dark:from-amber-400 dark:to-stone-500"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              BIRK & SHOES
